...
moderators = ["iMooseMoo","USER._NOT_FOUND","cutesanika23","Harshu.x","23_babybunny","OOILoveYouOO","_00_DEVIL_00","___kastu__28","Zx._QUEEN","amirhassan_","YO_ANGEL"]
...
class Bot(BaseBot):
    async def on_start(self, session_metadata: SessionMetadata) -> None:
        print("working")
        await self.highrise.walk_to(Position(16.0 , 0.25 , 26.0 , "FrontLeft"))
